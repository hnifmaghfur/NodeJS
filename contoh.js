    ...
    if(req.url === "/login/" && req.method === "POST"){
        ...
        req.on('data', function(data) {
            ...
            if(reqBody.length > 1e7) {
              res.writeHead(413, 'req Entity Too Large', {'Content-Type': 'text/html'});
              res.end('<!doctype html><html><head><title>413</title></head><body>413: req Entity Too Large</body></html>');
            }
        });
